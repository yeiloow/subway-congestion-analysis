...
def main():
    ...
    steps = [
        ...
        (
            "03_insert_subway_timetable.py",
            "run_insert_subway_timetable",
            "3단계: 지하철 시간표 추가",
        ),
        (
            "04_insert_congestion.py",
            "run_insert_congestion",
            "4단계: 혼잡도 데이터 추가",
        ),
        (
            "05_insert_job_population.py",
            "run_insert_job_population",
            "5단계: 직장인구 데이터 추가",
        ),
        (
            "06_insert_floating_population.py",
            "run_insert_floating_population",
            "6단계: 유동인구 데이터 추가",
        ),
        (
            "07_insert_living_population.py",
            "run_insert_living_population",
            "7단계: 생활인구 데이터 추가",
        ),
        (
            "08_insert_estimated_revenue.py",
            "run_insert_estimated_revenue",
            "8단계: 추정 매출 데이터 추가",
        ),
        (
            "09_insert_weather.py",
            "run_insert_weather",
            "9단계: 날씨 데이터 추가",
        ),
        (
            "10_insert_impact_analysis.py",
            "run_insert_impact_analysis",
            "10단계: 영향 분석 데이터 추가",
        ),
        (
            "11_insert_admin_dong_mapping.py",
            "run_insert_admin_dong_mapping",
            "11단계: 행정동 매핑 데이터 추가",
        ),
        (
            "12_insert_station_catchment_buildings.py",
            "main",
            "12단계: 역세권 계산",
        ),
        (
